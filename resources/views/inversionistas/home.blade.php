...
<section name="inversionistas" id="inversionistas" class="container-fluid">
    <div class="container">
        <div class="title text-center">
            ...
            <p class="text-justify">Realizamos el seguimiento continuo y reportes mensuales del avance del proyecto, soporte de los gastos del cultivo, contamos además con un modelo avanzado de administración de riesgos basados en históricos de producción y facturación, con el que buscamos la mitigación de estos.</p>
        </div>

        <div class="row">    
            <div class="title text-center">
                <strong><h1 class="mb-4">Comunidad de Inversionistas</h1></strong>
            </div>
            <div class="col-md-4">
